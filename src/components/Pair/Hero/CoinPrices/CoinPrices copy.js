...
class CoinPrices extends Component {
    ...
    axios
      ...
      .then(response => {
        if (response.data.length) {
          ...
          console.log(this.props.selectedCoin.deposit);
  ...
  fetchPairs = () => {
    // const { deposit: depositCoin } = this.props.selectedCoin;
    console.log('a');
        ...
        <div className={styles.container}>
          <div className={styles.row}>
            <div className="container">
              <CoinPairPrices tradingSymbolPair="BTCUSD" store={this.props.store} />
